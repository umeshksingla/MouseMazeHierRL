    ...
    for (n in 1:N){
        ...
        for (b in 1:B){
            ...
            for (step in 2:BL){
                ...
                for (j in 1:S){
                    V[s_current+1] += alpha * td_error * e[s_current+1];
                    e[s_current+1] = gamma * lamda * e[s_current+1];
                }
    ...
    for (n in 1:N){
        ...
        for (b in 1:B){
            ...
            for (step in 2:BL){
                ...
                // Propagate value to all other states
                for (j in 1:S){
                    V[s_current+1] += alpha_sub_phi[n] * td_error * e[s_current+1];
                    e[s_current+1] = gamma_sub_phi[n] * lamda_sub_phi[n] * e[s_current+1];
                }
