...
class Uncertainty(DynaQPlus):
    ...
    def generate_exploration_episode(self, discount_factor, action_selection_method, MAX_LENGTH):
        ...
        while len(episode_state_traj) <= MAX_LENGTH:
            ...
            s = s_next
            if len(episode_state_traj) % 5000 == 0:
        ...
        episode_state_trajs, episode_maze_trajs = self.wrap(episode_state_traj)
...
if __name__ == '__main__':
    ...
    param_sets = [
        {"gamma": 0.99, "action_selection_method": 'myopic',
            "initial_alpha": 1.5, "initial_lambda": 3, "initial_beta": 0.75},
    ]*1
    runids = run(Uncertainty(), param_sets, '/Users/us3519/mouse-maze/figs/may28', '500000', analyze=False)
    print(runids)

    # simulation_results = Uncertainty().simulate_multiple(param_sets, MAX_LENGTH=20000, N_BOUTS_TO_GENERATE=1)
